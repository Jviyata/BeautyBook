...
const DEMO_PROFESSIONALS = {
  '1': {
    ...
    gallery: ['/demo/sarah-nails.svg', '/demo/sarah-nails.svg', '/demo/sarah-nails.svg'],
    hours: [
  ...
  '2': {
    ...
    gallery: ['/demo/lash-perfect.svg', '/demo/lash-perfect.svg', '/demo/lash-perfect.svg'],
    hours: [
  ...
  '3': {
    ...
    gallery: ['/demo/glam-hair.svg', '/demo/glam-hair.svg', '/demo/glam-hair.svg'],
    hours: [
  ...
  '4': {
    ...
    gallery: ['/demo/tan-glow.svg', '/demo/tan-glow.svg', '/demo/tan-glow.svg'],
    hours: [
      { day: 'Monday', open: '10:00 AM', close: '6:00 PM' },
